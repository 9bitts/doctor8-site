 ...
 * Pré-requisito: node scripts/fetch-inhrr-ve-drugs.js
 * Uso: npx tsx scripts/seed-drugs-ve-inhrr.ts
 *
 * Versão com enriquecimento (presentation limpa, pharmaceuticalForm, dosage, searchPresentation).
...
async function main() {
  ...
  console.log(`Já existem ${existingSet.size} registros ${COUNTRY}.`);
  ...
  console.log(`\nConcluído. Inseridos: ${inserted}. Total VE: ${total}.`);
}
