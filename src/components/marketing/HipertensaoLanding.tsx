      ...
      <section className="relative overflow-hidden bg-slate-950">
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-16 pb-20 sm:pt-24 sm:pb-28">
          ...
          <h1 className="mt-4 max-w-2xl text-3xl sm:text-5xl font-bold tracking-tight text-white leading-[1.1]">
            {C.hero.title}
            <span className="block mt-2 text-rose-300 text-2xl sm:text-3xl font-semibold">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-rose-500 px-5 py-3 text-sm font-semibold text-white hover:bg-rose-600 transition shadow-lg shadow-rose-500/25"
            >
          ...
          <p className="mt-6 max-w-lg text-xs text-slate-400 leading-relaxed flex gap-2">
            <Phone size={14} className="shrink-0 mt-0.5 text-rose-400" />
              ...
              <ol className="mt-8 space-y-5">
                {C.howItWorks.steps.map((s) => (
                  <li key={s.step} className="flex gap-4">
                    <span className="text-2xl font-bold text-rose-200 leading-none w-10 shrink-0">
                      {s.step}
                    </span>
                    <div>
