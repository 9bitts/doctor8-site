      ...
      <section className="relative overflow-hidden bg-slate-950">
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-16 pb-20 sm:pt-24 sm:pb-28">
          ...
          <h1 className="mt-4 max-w-2xl text-3xl sm:text-5xl font-bold tracking-tight text-white leading-[1.1]">
            {C.hero.title}
            <span className="block mt-2 text-violet-300 text-2xl sm:text-3xl font-semibold">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-violet-500 px-5 py-3 text-sm font-semibold text-white hover:bg-violet-600 transition shadow-lg shadow-violet-500/25"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-violet-400/40 px-5 py-3 text-sm font-semibold text-violet-200 hover:bg-violet-500/15 transition"
            >
          ...
          <p className="mt-6 max-w-lg text-xs text-slate-200 leading-relaxed flex gap-2">
            <Phone size={14} className="shrink-0 mt-0.5 text-violet-400" />
