...
const PRO_REGISTER = "/register/professional/signup";
...
function LoginForm() {
  ...
  const psychologistLoginHref = buildAuthHref(PSYCHOLOGIST_LOGIN, { callbackUrl });
      ...
      <LoginCard>
        ...
        <div className="border-t border-white/10 mt-6 pt-6 text-center">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-xs">
            ...
            <Link
              href={psychologistLoginHref}
              className="text-violet-400/90 hover:text-violet-300 font-medium transition"
            >
