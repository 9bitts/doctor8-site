    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Produtividade e receita da cl?nica</p>
        </div>
      ...
      {loading || !data ? (
        ...
        <>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { icon: BarChart3, label: "Consultas", value: String(data.overview.totalAppointments), sub: `${data.overview.completionRate}% conclu?das` },
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              ...
              {data.byProfessional.length === 0 ? (
                <p className="text-slate-400 text-sm">Sem dados no per?odo.</p>
              ) : (
