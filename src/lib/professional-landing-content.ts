...
const pt: ProLandingContent = {
  ...
  professionPages: {
    ...
    psicologo: {
      ...
      platformFeatures: [
        "Escalas PHQ-9, GAD-7, BAI, BDI-II e DASS-21 com alertas de risco",
        "Anamnese digital, IA de notas (DAP/BIRP/SOAP) e chat com prontuário",
        "Sync Google Agenda, lembretes WhatsApp 24h e assistente Receita Saúde",
        "Plantão JIT, encaminhamento médico→psicólogo e trilha de auditoria LGPD",
      ],
    ...
    enfermeiro: {
      ...
      icon: "heart",
      title: "Enfermeiro(a)",
      subtitle: "Consulta de enfermagem online com SAE e prescrição de cuidados",
      heroDesc: "Documente o Processo de Enfermagem, aplique escalas clínicas e prescreva cuidados — com teleconsulta integrada e prontuário multiprofissional.",
      useCases: [
        { title: "Consulta de enfermagem", desc: "SAE completa, diagnósticos de enfermagem e plano de cuidados por vídeo." },
        { title: "Escalas clínicas", desc: "Braden, Morse, dor e Glasgow com histórico gráfico na ficha do paciente." },
        { title: "Prescrição de enfermagem", desc: "Cuidados, metas e intervenções documentados — distinto de receita médica." },
        { title: "Telenfermagem", desc: "Monitoramento entre consultas com questionários e registro de sintomas pelo paciente." },
      ],
      platformFeatures: [
        "SAE e diagnósticos de enfermagem no prontuário",
        "Escalas de risco com evolução",
        "Prescrição de cuidados e metas",
        "App do paciente para monitoramento",
      ],
      volunteerTitle: "Cuidados de enfermagem para famílias afetadas",
      volunteerDesc: "Atenda na fila humanitária com telenfermagem documentada e orientações de cuidado.",
      ctaPrimary: "Criar conta de enfermeiro(a)",
      ctaVolunteer: "Voluntariar-se no SOS Venezuela",
    },
    farmaceutico: {
      slug: "farmaceutico",
      icon: "pill",
      title: "Farmacêutico(a)",
      subtitle: "Telefarmácia com revisão medicamentosa e prescrição farmacêutica",
      heroDesc: "Revisão de farmacoterapia, conciliação medicamentosa, monitorização terapêutica e prescrição farmacêutica — com teleconsulta integrada e prontuário multiprofissional (CFF 727).",
      useCases: [
        { title: "Consulta farmacêutica", desc: "Revisão completa da medicação do paciente por vídeo, com registro no prontuário." },
        { title: "Conciliação medicamentosa", desc: "Compare listas de medicação e documente discrepâncias na transição de cuidado." },
        { title: "Prescrição farmacêutica", desc: "Emita prescrições dentro da competência farmacêutica (CFF 586) com PDF." },
        { title: "Dispensação e validação", desc: "Valide receitas médicas da plataforma e registre dispensação conforme CFM/CFF." },
      ],
      platformFeatures: [
        "Revisão farmacoterapia e interações medicamentosas",
        "Conciliação e monitorização terapêutica",
        "Prescrição farmacêutica com PDF (CRF)",
        "App do paciente para questionários e monitoramento",
      ],
      volunteerTitle: "Cuidado farmacêutico para famílias afetadas",
      volunteerDesc: "Atenda na fila humanitária com telefarmácia documentada e orientação sobre medicamentos.",
      ctaPrimary: "Criar conta de farmacêutico(a)",
      ctaVolunteer: "Voluntariar-se no SOS Venezuela",
    },
    dentista: {
      slug: "dentista",
      icon: "smile",
      title: "Dentista",
      subtitle: "Consultório e teleodontologia com odontograma, planos e gestão clínica",
      heroDesc: "Odontograma FDI, periodontograma, planos de tratamento, controle de prótese e ortodontia — presencial e por teleconsulta, com TCLE e prontuário CFO.",
      useCases: [
        { title: "Atendimento no consultório", desc: "Agenda por cadeira, anamnese odontológica, odontograma interativo e evoluções clínicas na mesma ficha." },
        { title: "Plano de tratamento e orçamento", desc: "Monte orçamentos por procedimento, vincule ao odontograma e registre aprovação do paciente." },
        { title: "Teleodontologia", desc: "Teleconsulta com prontuário, prescrições com validade legal e odontograma aberto na sessão de vídeo." },
        { title: "Especialidades integradas", desc: "Periodontograma, controle protético, ortodontia e fotos clínicas — tudo no portal Odontologia." },
      ],
      platformFeatures: [
        "Portal /odontologo com módulos clínicos odontológicos completos",
        "Odontograma permanente e decídua (notação FDI)",
        "Anamnese com TCLE conforme Resolução CFO 278/2025",
        "Agenda, financeiro e prescrições integrados",
      ],
      volunteerTitle: "Cuidado odontológico para famílias afetadas",
      volunteerDesc: "Ofereça orientação e teleconsulta odontológica na fila humanitária quando disponível.",
      ctaPrimary: "Criar conta de dentista",
      ctaVolunteer: "Voluntariar-se no SOS Venezuela",
    },
    cuidados_paliativos: {
...
const en: ProLandingContent = {
  ...
  professionPages: {
    ...
    enfermeiro: { slug: "enfermeiro", icon: "heart", title: "Nurse", subtitle: "Online nursing consultations with SAE and care prescriptions", heroDesc: "Document the Nursing Process, apply clinical scales and prescribe nursing care — with integrated telehealth and multiprofessional records.", useCases: [{ title: "Nursing consultation", desc: "Full SAE, nursing diagnoses and care plan by video." }, { title: "Clinical scales", desc: "Braden, Morse, pain and Glasgow with chart history." }, { title: "Nursing prescription", desc: "Care goals and interventions documented — separate from medical prescriptions." }, { title: "Tele-nursing", desc: "Between-visit monitoring with patient symptom logging." }], platformFeatures: ["SAE and nursing diagnoses in the chart", "Risk scales with trends", "Care prescriptions and goals", "Patient app for monitoring"], volunteerTitle: "Nursing care for affected families", volunteerDesc: "Serve in the humanitarian queue with documented tele-nursing and care guidance.", ctaPrimary: "Create nurse account", ctaVolunteer: "Volunteer for SOS Venezuela" },
    farmaceutico: { slug: "farmaceutico", icon: "pill", title: "Pharmacist", subtitle: "Telepharmacy with medication review and pharmaceutical prescriptions", heroDesc: "Medication therapy review, reconciliation, therapeutic monitoring and pharmaceutical prescribing — integrated telehealth per CFF 727.", useCases: [{ title: "Pharmaceutical consultation", desc: "Full medication review by video with chart documentation." }, { title: "Medication reconciliation", desc: "Compare medication lists and document discrepancies at care transitions." }, { title: "Pharmaceutical prescription", desc: "Issue prescriptions within pharmacist scope (CFF 586) with PDF." }, { title: "Dispensing validation", desc: "Validate platform medical prescriptions and record dispensing." }], platformFeatures: ["Medication review and interaction screening", "Reconciliation and therapeutic monitoring", "Pharmaceutical prescription PDF (CRF)", "Patient app for intake and monitoring"], volunteerTitle: "Pharmaceutical care for affected families", volunteerDesc: "Serve in the humanitarian queue with documented telepharmacy and medication guidance.", ctaPrimary: "Create pharmacist account", ctaVolunteer: "Volunteer for SOS Venezuela" },
    dentista: { slug: "dentista", icon: "smile", title: "Dentist", subtitle: "In-office and teledentistry with charting, treatment plans and clinical management", heroDesc: "FDI odontogram, periodontogram, treatment plans, prosthetic control and orthodontics — in-person and telehealth with informed consent and secure records.", useCases: [{ title: "In-office care", desc: "Chair scheduling, dental anamnesis, interactive odontogram and clinical notes in one chart." }, { title: "Treatment plan and budget", desc: "Build procedure-based estimates linked to the odontogram with patient approval." }, { title: "Teledentistry", desc: "Video visits with chart, legally valid prescriptions and odontogram open during the session." }, { title: "Integrated specialties", desc: "Periodontogram, prosthetic tracking, orthodontics and clinical photos in the Dentistry portal." }], platformFeatures: ["/odontologo portal with full dental clinical modules", "Permanent and deciduous FDI odontogram", "Anamnesis with informed consent (CFO 278/2025)", "Integrated scheduling, billing and prescriptions"], volunteerTitle: "Dental care for affected families", volunteerDesc: "Offer dental guidance and telehealth in the humanitarian queue when available.", ctaPrimary: "Create dentist account", ctaVolunteer: "Volunteer for SOS Venezuela" },
...
const es: ProLandingContent = {
  ...
  professionPages: {
    ...
    enfermeiro: { slug: "enfermeiro", icon: "heart", title: "Enfermero(a)", subtitle: "Consulta de enfermería online con SAE y prescripción de cuidados", heroDesc: "Documenta el Proceso de Enfermería, aplica escalas clínicas y prescribe cuidados — con teleconsulta integrada e historial multiprofesional.", useCases: [{ title: "Consulta de enfermería", desc: "SAE completa, diagnósticos de enfermería y plan de cuidados por video." }, { title: "Escalas clínicas", desc: "Braden, Morse, dolor y Glasgow con historial en la ficha." }, { title: "Prescripción de enfermería", desc: "Cuidados, metas e intervenciones documentados — distinto de receta médica." }, { title: "Telenfermería", desc: "Monitoreo entre consultas con cuestionarios y registro de síntomas del paciente." }], platformFeatures: ["SAE y diagnósticos de enfermería en el historial", "Escalas de riesgo con evolución", "Prescripción de cuidados y metas", "App del paciente para monitoreo"], volunteerTitle: "Cuidados de enfermería para familias afectadas", volunteerDesc: "Atiende en la fila humanitaria con telenfermería documentada y orientaciones de cuidado.", ctaPrimary: "Crear cuenta de enfermero(a)", ctaVolunteer: "Voluntariarse en SOS Venezuela" },
    farmaceutico: { slug: "farmaceutico", icon: "pill", title: "Farmacéutico(a)", subtitle: "Telefarmacia con revisión medicamentosa y prescripción farmacéutica", heroDesc: "Revisión de farmacoterapia, conciliación, monitorización terapéutica y prescripción farmacéutica — teleconsulta integrada (CFF 727).", useCases: [{ title: "Consulta farmacéutica", desc: "Revisión completa de medicación por video con registro en el historial." }, { title: "Conciliación medicamentosa", desc: "Compara listas de medicación y documenta discrepancias." }, { title: "Prescripción farmacéutica", desc: "Emite prescripciones en el ámbito farmacéutico (CFF 586) con PDF." }, { title: "Dispensación y validación", desc: "Valida recetas médicas de la plataforma y registra dispensación." }], platformFeatures: ["Revisión farmacoterapia e interacciones", "Conciliación y monitorización terapéutica", "Prescripción farmacéutica PDF (CRF)", "App del paciente para cuestionarios y monitoreo"], volunteerTitle: "Cuidado farmacéutico para familias afectadas", volunteerDesc: "Atiende en la fila humanitaria con telefarmacia documentada.", ctaPrimary: "Crear cuenta de farmacéutico(a)", ctaVolunteer: "Voluntariarse en SOS Venezuela" },
    dentista: { slug: "dentista", icon: "smile", title: "Dentista", subtitle: "Consultorio y teleodontología con odontograma, planes y gestión clínica", heroDesc: "Odontograma FDI, periodontograma, planes de tratamiento, control de prótesis y ortodoncia — presencial y por teleconsulta, con consentimiento informado.", useCases: [{ title: "Atención en consultorio", desc: "Agenda por sillón, anamnesis odontológica, odontograma interactivo y evoluciones en la misma ficha." }, { title: "Plan de tratamiento y presupuesto", desc: "Arma presupuestos por procedimiento vinculados al odontograma con aprobación del paciente." }, { title: "Teleodontología", desc: "Teleconsulta con historial, prescripciones válidas y odontograma abierto en la sesión de video." }, { title: "Especialidades integradas", desc: "Periodontograma, control protésico, ortodoncia y fotos clínicas en el portal Odontología." }], platformFeatures: ["Portal /odontologo con módulos clínicos odontológicos", "Odontograma permanente y decíduo (notación FDI)", "Anamnesis con consentimiento informado (CFO 278/2025)", "Agenda, finanzas y prescripciones integradas"], volunteerTitle: "Cuidado odontológico para familias afectadas", volunteerDesc: "Ofrece orientación y teleconsulta odontológica en la fila humanitaria cuando estés disponible.", ctaPrimary: "Crear cuenta de dentista", ctaVolunteer: "Voluntariarse en SOS Venezuela" },
