...
export const EMPLOYER_NAV: PlatformNavEntry[] = [
  ...
  { href: "/empresas/estrutura", labelKey: "emp.nav.structure", roles: ["EMPLOYER"], iconKey: "Layers" },
  ...
  { href: "/empresas/esocial", labelKey: "emp.nav.esocial", roles: ["EMPLOYER"], iconKey: "FileSpreadsheet" },
  { href: "/empresas/aep", labelKey: "emp.nav.aep", roles: ["EMPLOYER"], iconKey: "ClipboardList" },
  { href: "/empresas/encaminhamentos", labelKey: "emp.nav.referrals", roles: ["EMPLOYER"], iconKey: "MessageSquare" },
...
export const PLATFORM_PUBLIC_ROUTES: PublicRouteEntry[] = [
  ...
  { href: "/empresas/estrutura", description: "SESMT structure: sectors, functions, GHE" },
  { href: "/empresas/esocial", description: "eSocial CAT / certificates / transmissions" },
  { href: "/empresas/encaminhamentos", description: "Care referrals from screening / CID F / AET" },
