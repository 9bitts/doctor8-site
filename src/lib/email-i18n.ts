...
export const EMAIL_APPOINTMENT_CANCELLED: Record<EmailLang, {
  ...
  en: {
    ...
    hi: (n) => `Hi <strong>${n}</strong>,`,
    intro: "Your appointment was cancelled by your provider. Please sign in to Doctor8 to book a new time:",
    doctor: "Professional",
    date: "Date",
    time: "Time",
    view: "View appointments",
  ...
  pt: {
    ...
    hi: (n) => `Olá <strong>${n}</strong>,`,
    intro: "Sua consulta foi cancelada pelo profissional. Acesse o Doctor8 para remarcar:",
    doctor: "Profissional",
    date: "Data",
    time: "Horário",
    view: "Ver consultas",
  ...
  es: {
    ...
    hi: (n) => `Hola <strong>${n}</strong>,`,
    intro: "Su cita fue cancelada por el profesional. Acceda a Doctor8 para reprogramar:",
    doctor: "Profesional",
    date: "Fecha",
    time: "Hora",
    view: "Ver citas",
