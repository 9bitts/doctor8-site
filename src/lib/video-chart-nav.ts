...
export function buildVideoChartLinks(
  ...
  if (panel === "nurse") {
    ...
    return {
      ...
      nurseSbar: chartActionUrl("/enfermeiro/sbar", chartId, { returnUrl }),
      nurseMedCheck: chartActionUrl("/enfermeiro/checagem", chartId, { returnUrl }),
      nurseMedRx: chartActionUrl("/enfermeiro/medicamentos", chartId, { returnUrl }),
      nutriAnamnesis: null as string | null,
      nutriAnthropometry: null as string | null,
      nutriMealPlans: null as string | null,
      nutriFoodDiary: null as string | null,
